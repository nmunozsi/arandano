...
- [x] [T1 — config schema for architect role](T1-config-schema.md)
- [x] [T2 — architecture.md template asset](T2-architecture-template.md)
- [x] [T3 — architect skill](T3-architect-skill.md)
- [x] [T4 — synthesizeArchitectTask + tests](T4-synthesize-architect-task.md)
- [x] [T5 — wire architect synthesis into Orchestrator](T5-wire-orchestrator.md)
- [x] [T6 — --with-architect / --no-architect CLI flags](T6-cli-flags.md)
- [x] [T7 — stack templates: config block + arch skeleton](T7-stack-template-config-and-arch.md)
- [x] [T8 — seed docs/architecture.md in the monorepo](T8-seed-monorepo-architecture.md)
- [x] [T9 — worker architect driver](T9-worker-architect-driver.md)
- [x] [T10 — rebuild worker image and confirm GHCR push](T10-rebuild-worker-image.md)
- [x] [T11 — migrate node-ts-toy](T11-migrate-node-ts-toy.md)
- [x] [T12 — e2e two-task plan against node-ts-toy](T12-e2e-two-task-plan.md)
