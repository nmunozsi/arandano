...
- [ ] **Step 9: Create `CODE_OF_CONDUCT.md`**
...
- [ ] **Step 10: Create `CHANGELOG.md` (semantic-release will manage)**
...
- [ ] **Step 11: Create `.github/PULL_REQUEST_TEMPLATE.md` and `.github/ISSUE_TEMPLATE/bug_report.md`**
...
- [ ] **Step 7: Create `packages/core/src/index.ts` placeholder**
...
- [ ] **Step 1: Add lint/format/hook devDependencies**
...
- [ ] **Step 4: Create `.commitlintrc.cjs`**
...
- [ ] **Step 7: Initialize husky and create hooks**
...
- [ ] **Step 8: Run all gates locally to verify**
...
- [ ] **Step 2: Create `.github/workflows/release.yml` (stub — wired up in a later phase)**
...
- [ ] **Step 1: Create `packages/core/src/types/quality.ts`**
...
- [ ] **Step 2: Create `packages/core/src/types/task.ts`**
...
- [ ] **Step 3: Create `packages/core/src/types/role.ts`**
...
- [ ] **Step 4: Create `packages/core/src/types/executor.ts`**
...
- [ ] **Step 5: Create `packages/core/src/types/config.ts`**
...
- [ ] **Step 6: Create `packages/core/src/types/index.ts`**
...
- [ ] **Step 3: Implement `packages/core/src/parsers/task-md.ts`**
...
- [ ] **Step 4: Export the parser from `packages/core/src/index.ts`**
...
- [ ] **Step 3: Implement `packages/core/src/state/store.ts`**
...
- [ ] **Step 6: Run all gates one more time before commit**
...
- [ ] **Step 1: Create `packages/executors-docker/package.json`**
...
- [ ] **Step 2: Create `packages/executors-docker/src/DockerExecutor.ts` (stub)**
...
- [ ] **Step 3: Smoke test for executors-docker**
...
- [ ] **Step 4: Create `packages/templates` (similar shape)**
...
- [ ] **Step 4b: Create `packages/skills` (registry stub)**
...
- [ ] **Step 5: Create `packages/cli` with oclif skeleton**
...
- [ ] **Step 6: Build the workspace and run tests**
...
- [ ] **Step 7: Run all gates one more time**
...
- [ ] **Step 9: Open PR (or push to main if branch protection isn't enforced yet)**
